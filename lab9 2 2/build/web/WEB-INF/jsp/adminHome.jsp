<%-- 
    Document   : adminHome
    Created on : Dec 10, 2019, 9:20:08 PM
    Author     : mansiagrawal
--%>
...
<h1>Hi, ${personname}</h1>
        ...
        <a href="${contextPath}/flight/add" >Add Flight</a> <br />
    ...
    <a href="${contextPath}/passenger/viewpassengers.htm">View Passenger List </a><br/><br/>
    <c:if test = "${personname != null}">
